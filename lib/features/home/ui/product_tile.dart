...
class ProductTileWidget extends StatelessWidget {
  ...
  const ProductTileWidget({Key? key, required this.products, required this.homeBloc}) : super(key: key);
        ...
        children: [
         ...
         const SizedBox(
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Text('\$${products.price}', style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 17),),
              Row(
                children: [
                  IconButton(
                      onPressed: () {
                        homeBloc.add(HomeProductWishlistClick(products));
                      },
                      icon: const Icon(Icons.favorite_border_outlined)),
                  IconButton(
                      onPressed: () {
                        homeBloc.add(HomeProductCartClick(products));
                      },
